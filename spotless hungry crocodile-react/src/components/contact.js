    ...
    <div className="contact-contact20 thq-section-padding">
      <div className="contact-max-width thq-section-max-width">
        <div className="contact-section-title">
          <span className="contact-text1 thq-body-small">{props.content2}</span>
...
Contact.defaultProps = {
  content4: 'Stay connected with us for the latest updates and news.',
  content3:
  ...
  content1:
    'Have a question or want to learn more about Elevate? Reach out to us!',
  content5:
    'Follow us on social media for more insights and innovation trends.',
  phone1: '+123-456-7890',
  heading1: 'Contact Us',
  address1: '123 Main Street, City, Country',
  email1: 'info@elevateinnovation.com',
}
